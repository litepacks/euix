...
const EUIXEngineModule = await import('../../packages/core/src/EUIXEngine.js');
const EUIXEngine = EUIXEngineModule.default || EUIXEngineModule.EUIXEngine;

const kanbanXml = fs.readFileSync(path.resolve(import.meta.dirname, '../../apps/playground/components/KanbanSection.xml'), 'utf-8');
