...
describe('DocPortalSection Tab Switching', () => {
    ...
    beforeEach(async () => {
        ...
        const engineModule = await import('../../packages/core/src/EUIXEngine.js');
    ...
    it('should switch active_tab to docs when Documentation button is clicked', async () => {
        const xmlPath = path.resolve(import.meta.dirname, '../../apps/playground/components/DocPortalSection.xml');
