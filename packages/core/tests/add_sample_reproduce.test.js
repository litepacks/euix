...
describe('Add Employee and Add Holding Verification Suite', () => {
    ...
    it('should test Add Holding in CryptoPortfolioSection', () => {
        const cryptoXml = fs.readFileSync(path.resolve(__dirname, '../../../apps/playground/components/CryptoPortfolioSection.xml'), 'utf-8');
        const xml = `
        <uid_spec>
            <data_model>
    ...
    it('should test Add Employee in TableSection', () => {
        const tableXml = fs.readFileSync(path.resolve(__dirname, '../../../apps/playground/components/TableSection.xml'), 'utf-8');
        const xml = `
        <uid_spec>
            <data_model>
